...
function Button(props){
    function handleSubmit(){
      ...
      alert("Thank you for reaching out!Your email has been submitted and we will be in touch with you shortly. ")
    }
    return(
    ...
    return(
      <div className="main">
        <div className="main-body">
             <input className="contact" type="text" value="+21676534521" readOnly/>
          </div>
